...
#define P_43D_DHV_AMT630A_HRW_20150327_EN  			DISABLE
#define P_GL043038C0_V1_DHV_AMT630A_YD_111EN		ENABLE
...
#define ADC_CH_LIST         			{CH1} //{CH0,CH1,CH2} //通道列表   
...
#define MAINMENU_START_X_POS   			0X00AE     //MAIN MENU 菜单的X起始位置
#define MAINMENU_START_Y_POS   			0X00DF   //MAIN MENU 菜单的Y起始位置

#define SOURCEMENU_START_X_POS 			0X01D0   //SOURCE MENU 菜单的X起始位置
#define SOURCEMENU_START_Y_POS 			0X000A   //SOURCE MENU 菜单的Y起始位置
...
#define MENU_START_X_POS   			0X00DF        //MAIN MENU 菜单的X起始位置
#define MENU_START_Y_POS   			0X00DB       //MAIN MENU 菜单的Y起始位置
//[OSD default language]
#define DEFAULT_LANGUAGE        		ENGLISH //KOREAN	ENGLISH  //OSD 默认语言
...
//[Logo display mode]
#define LOGO_DISP_MODE          			POWER_ON_NOSIGNAL_DISP_LOGO//NOSIGNAL_DISP_LOGO//POWER_ON_DISP_LOGO


//[Logo display backcolor]
#define LOGO_DISP_BACKCOLOR              GRAY// WHITE     //LOGO显示背景颜色


//[Logo menu X Y position]
#define LOGO1MENU_START_X_POS 		    0X004D  //LOGO1 MENU 菜单的X起始位置
#define LOGO1MENU_START_Y_POS 		    0X0034   //LOGO1 MENU 菜单的Y起始位置
