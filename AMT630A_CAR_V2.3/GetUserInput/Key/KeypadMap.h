...
//#define hw_KEY_POWER    	makeUint16 (CH2, hw_keyAdcVal(39000))
//#define hw_KEY_SOURCE     	makeUint16 (CH2, hw_keyAdcVal(27000))
#define hw_KEY_MENU   		makeUint16 (CH1, hw_keyAdcVal(4700))
#define hw_KEY_LEFT     	makeUint16 (CH1, hw_keyAdcVal(1000))
#define hw_KEY_RIGHT    	makeUint16 (CH1, hw_keyAdcVal(2000))
...
#define AdcKeyCmdMap       {hw_KEY_LEFT ,	   KEY_LEFT       },\
                      {hw_KEY_MENU,      KEY_MENU         },\
                      {hw_KEY_RIGHT ,	   KEY_RIGHT      },
