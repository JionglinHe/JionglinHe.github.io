...
{
    {0,13,RED,GRAY,RED,GRAY, GetContrastVal,osdDecNum|osdEnd},
};

DrawGuageType CODE Gugae_Contrast[]=
{
    {1,1,CYAN,GRAY,CYAN,GRAY, MAX_VALUE,GetContrastVal,osdEnd},
};
...
{
   {0,1,RED,GRAY,RED,GRAY,DWT_Text,ContrastMenu_TitelStr,osdEnd},
};
