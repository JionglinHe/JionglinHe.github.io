...
{
    {0,13,RED,GRAY,RED,GRAY, GetSaturationVal,osdDecNum|osdEnd},
};

DrawGuageType CODE Gugae_Saturation[]=
{
    {1,1,CYAN,GRAY,CYAN,GRAY, MAX_VALUE,GetSaturationVal,osdEnd},
};
...
{
   {0,1,RED,GRAY,RED,GRAY,DWT_Text,SaturationMenu_TitelStr,osdEnd},
};
