...
BOOL BrightnessMenuItem_DrawStyle(void)
{
    ...
    OsdWndClear(0X00, 0X00, 0X01, 0X10);
	return 0;
}
...
{
    {0,13,RED,GRAY,RED,GRAY, GetBrightnessVal,osdDecNum|osdEnd},
};

DrawGuageType CODE Gugae_Brightness[]=
{
    {1,1,CYAN,GRAY,CYAN,GRAY, MAX_VALUE,GetBrightnessVal,osdEnd},
};
...
{
   {0,1,RED,GRAY,RED,GRAY,DWT_Text,BrightnessMenu_TitelStr,osdEnd},
};
